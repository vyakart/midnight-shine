...
class Star {
    ...
    render(p: number, controller: AnimationController) {
        ...
        if (q > 0) {
            ...
            // Use mixed easing functions, soft start with elastic end
            ...
            if (displacementProgress < 0.3) {
                // Starting phase: mainly linear and quadratic
            ...
            // Particle size animation: initial normal, middle slightly larger, final adjusted by finalScale
